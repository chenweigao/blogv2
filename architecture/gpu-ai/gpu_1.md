...
### 5.1. 硬件线程块调度器 （Thread Block Scheduler）
...
## 6. Explicit Predicate Registers（显式谓词寄存器）
...
### 6.1. 什么是 Explicit Predicate Registers？
